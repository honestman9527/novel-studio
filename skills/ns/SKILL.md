---
name: ns
description: "Novel Studio 总入口。用于单本小说项目的路由和阶段协调：初始化、脑暴、框架、canon/notes、调研、写作、修订、文案、视觉。当用户不知道用哪个 skill、请求混合动作、需要拆分过长文件，或要从模糊需求推进到下一步时使用。"
---
...
- `NOVEL.md` 可读；创建或修改要有用户本轮明确同意。
- YAML/frontmatter/`NOVEL.md` 写短事实；长说明进 `novel-studio/notes/*.md`。

---
name: ns-canon
description: "小说 canon 记忆维护技能。用于读取、更新单本 NS 项目的 NOVEL.md 全局约束、已定事实、计划、连续性、正文索引、风格约束、来源边界和视觉索引；维护 NOVEL.md、novel-studio/*.yaml 与 notes/*.md。当用户要求记住设定、保存资料、更新大纲、整理进度、记录必须遵守/不要写、处理章末笔记、修正连续性或接手旧小说记忆时使用。初始化走 ns-start。"
---
...
- `NOVEL.md` 放根目录，只写全局约束：必须遵守、不要写/不要改、风格偏好、内容边界、结构偏好和待确认。
...
- 用户说“以后都要”“不要再写”“这个不能改”“保留这个味道”时，先更新 `NOVEL.md`。
